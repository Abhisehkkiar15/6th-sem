...
CREDIT = os.environ.get("CREDIT", "Crozn X Dex")
...
PREMIUM_CHANNEL = "https://t.me/+KdgyenHjB3M4YWY1"
# Thumbnail Configuration
THUMBNAILS = list(map(str, os.environ.get("THUMBNAILS", "https://ibb.co/8D3yNC5t").split())) # Image Link For Default Thumbnail 
